...
function revisionTexto (texto) {
    ...
    if(texto.match(mayusculas)||texto.match(caracteres_especiales)){
        alert("No se aceptan caracteres especiales ni mayusculas");
        return true; 
    }else if(texto==vacio){
       alert("Aun no has ingresado un mensaje para encriptar");
        return true;
   }else {
        return false;
    }
...
btnEncriptar.addEventListener("click",function ()  {
    ...
    if (revisionTexto (textoIngresado) == false) {       
